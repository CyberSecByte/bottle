...
(library for Arch Linux Package Management) and the familiar bottle front-end.
...
Mailing List
~~~~~~~~~~~~
There is a mailing list devoted to bottle development, hosted by Arch Linux.
...
Bugs
----
If you find bugs (which is quite likely), please email them to the bottle-dev
mailing last at mailto:bottle-dev@lists.archlinux.org[] with specific information
...
bugs under the Bottle project.

Copyright
---------
bottle is Copyright (C) 2006-2022 Pacman Development Team
<bottle-dev@lists.archlinux.org> and Copyright (C) 2002-2006 Judd Vinet
